...
This guide covers all configuration options available in Zero Email Client, from basic setup to advanced customization.
...
<Files>
  <Folder name="Zero/" description="Project root" defaultOpen>
    ...
    <File name="package.json" description="Main package configuration" />
    ...
    <File name="eslint.config.mjs" description="ESLint configuration" />
    <File name="docker-compose.db.yaml" description="Database services" />
    <Folder name="apps/mail/" description="Frontend app">
      <File name="tailwind.config.ts" />
      <File name="vite.config.ts" />
      <File name="react-router.config.ts" />
    </Folder>
    <Folder name="apps/server/" description="Backend app">
...
```typescript title="config/app.ts"
