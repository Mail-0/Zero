...
import { SelectionGradient, useSelectionTracking } from '@/hooks/ui/use-selection-tracking';
...
>(({ className, ...props }, ref) => {
  const listScrollableRef = React.useRef<HTMLDivElement | null>(null);

  const { selectedItemTop, selectedItemHeight, showGradient } =
    useSelectionTracking(listScrollableRef);

  return (
    <div className="group relative">
      <SelectionGradient
        showGradient={showGradient}
        selectedItemTop={selectedItemTop}
