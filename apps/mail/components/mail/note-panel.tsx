...
export function NotesPanel({ threadId }: NotesPanelProps) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {isOpen && (
        <div
          className="animate-in fade-in-20 zoom-in-95 dark:bg-panelDark absolute left-[-175px] top-full mt-2 z-50 w-[300px] max-w-[100vw] overflow-hidden rounded-lg border border-t bg-[#FAFAFA] shadow-lg duration-100 sm:absolute sm:right-0 sm:top-full sm:mt-2 sm:h-auto sm:max-h-[80vh] sm:w-[350px] sm:max-w-[90vw] sm:left-[-200px] sm:border lg:left-[-200px] xl:left-[-300px] dark:border-[#252525]"
