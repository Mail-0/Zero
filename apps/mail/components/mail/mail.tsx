...
import { FilterIcon, PlusIcon, RefreshCcw, XIcon, Check, ChevronDown } from 'lucide-react';
              ...
              <div className="p-2 px-[22px]">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <Button
                    variant="outline"
                    className={cn(
                      'relative flex h-8 w-fit cursor-pointer select-none items-center justify-start gap-2 overflow-hidden rounded-lg border bg-neutral-300 px-2 text-left text-sm font-normal text-neutral-600 shadow-none ring-0 hover:text-neutral-800 focus-visible:ring-0 focus-visible:ring-offset-0 dark:border-none dark:bg-[#262626] dark:text-[#cccccc]',
                      'transition-colors duration-200 hover:bg-neutral-400 dark:hover:bg-[#333333]',
                  ...
                  >
                    <Search className="h-4 w-4 fill-neutral-500 dark:fill-[#6F6F6F]" />
                  </Button>
                  ...
                  <Button
                    variant="outline"
                    className={cn(
                      'text-muted-foreground flex h-8 w-fit flex-shrink-0 flex-grow cursor-pointer select-none items-center justify-center gap-2 overflow-hidden rounded-lg border bg-white pl-3 pr-3 text-sm font-normal shadow-none ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 md:pr-1 dark:border dark:border-neutral-700 dark:bg-[#141414]',
                  ...
                  >
                    <span className="hidden xl:inline-block">Power Menu</span>
                    <span className="inline-block xl:hidden">Menu</span>
    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          className={cn(
            'flex h-full min-w-fit flex-1 items-center gap-1 rounded-md border-none px-2 text-white',
            `${isOpen ? 'bg-accent' : 'bg-[#006FFE]'}`,
          )}
